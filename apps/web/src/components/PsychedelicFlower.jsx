...
const PsychedelicFlower = ({ onClose }) => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center relative bg-gradient-to-br from-purple-900/20 to-pink-900/20">
      <button
        onClick={onClose}
      ...
      <div className="z-10 mt-8 text-center space-y-6">
        <h1 className="text-4xl font-serif text-purple-800 dark:text-purple-300 mb-2">
        ...
        {hasBloomed && (
          <motion.div
            ...
            className="text-pink-600 dark:text-pink-400 font-medium italic text-lg"
          >
